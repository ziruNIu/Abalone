...
mod0=data_2 %>% lm(formula = sqrt_log_Ring~1)
modForw1=stepAIC(mod0,model_ancova_1,trace=T,
     direction=c('forward'))
modForw1
modForw1=stepAIC(model_1,model_ancova_1,trace=T,
     direction=c('forward'))
modForw1
```
```{r}
modBacw=stepAIC(model_1, model_ancova_1,trace=T,
     direction=c('backward'))
modBacw
```
```{r}
AIC(model_1, model_ancova_1,model_height,mod0)
BIC(model_1, model_ancova_1,model_height,mod0)
```
The simple model has the lowest AIC and BIC.
```{r}
AIC(model_ancova_3,model_ancova_3_0,model_ancova_3_00)
```
```{r}
...
```{r}
AIC(model_1, model_ancova_1,model_ancova_2,model_ancova_2_1,model_ancova_3,model_ancova_3_1,model_ancova_3_0,model_ancova_3_00)
BIC(model_1, model_ancova_1,model_ancova_2,model_ancova_2_1,model_ancova_3,model_ancova_3_1,model_ancova_3_0,model_ancova_3_00)
```
model_1 has the lowest AIC and BIC, but the interaction terms are significant.
...
predict_error(model_ancova, abalone_test,ancova = TRUE)
...
```{r}
# let me see
result = data.frame(y = abalone_test$Rings, y_predict = predict_as_ring(model_ancova,abalone_test,ancova = TRUE))
```
...
Feature selection:
Use AIC/BIC: not include , simple models are better
Use significance test: No Sex, include all variables
Withe Sex interaction terms, include all variables then select by Anova (model_ancova_3_0)
